# docker run -it --name client_test --net host --gpus all -v /root/work_data/Workspace/FunASR_xw/funasr/runtime/triton_gpu:/workspace/ soar97/triton-k2:22.12.1 bash
